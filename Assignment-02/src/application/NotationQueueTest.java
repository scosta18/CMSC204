...
public class NotationQueueTest {
	...
	public void testDequeue() {
		try {
			...
			stringQ.dequeue();
			assertTrue("This will cause a QueueUnderflowException", false);
		}
		catch (QueueUnderflowException e){
			assertTrue("This will cause a QueueUnderflowException", true);
		}
		catch (Exception e){
			assertTrue("This will cause a QueueUnderflowException", false);
		}
	...
	public void testEnqueue() {
		try {
			...
			assertTrue("This will cause a QueueOverflowException", true);
		}
		catch (Exception e){
			assertTrue("This will cause a QueueOverflowException", false);
		}
	}
